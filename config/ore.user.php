...
return [
    ...
    */
    ...
    |
    */
    'manager' => Railken\LaraOre\User\UserManager::class,
    ...
    |
    */
    'repository' => Railken\LaraOre\User\UserRepository::class,
    ...
    |
    */
    'serializer' => Railken\LaraOre\User\UserSerializer::class,
    ...
    |
    */
    'validator' => Railken\LaraOre\User\UserValidator::class,
    ...
    |
    */
    'authorizer' => Railken\LaraOre\User\UserAuthorizer::class,
